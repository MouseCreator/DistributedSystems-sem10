...
public class GUIPipeline {
    public static void run(int width, int height, int numVertices, Coloring coloring, boolean displayIds) {
        ...
        BufferedImage beforeImage = visualization.visualize(initialModel, colorMap, displayIds);
        ...
        BufferedImage afterImage = visualization.visualize(afterModel, colorMap, displayIds);
